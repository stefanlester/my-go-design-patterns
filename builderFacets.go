...
type PersonBuilder struct {
  Person__ *Person__ // needs to be inited
}

func NewPersonBuilder() *PersonBuilder {
  return &PersonBuilder{&Person__{}}
}

func (it *PersonBuilder) Build() *Person__ {
  return it.Person__
}
